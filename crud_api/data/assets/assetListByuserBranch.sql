...
AND COUNTED.[Reference] IN ('','ชำรุดรอซ่อม', 'รอตัดชำรุด ','สภาพดี','ไม่ได้ระบุสถานะ', 'QR Code ไม่สมบูรณ์ (สภาพดี)','QR Code ไม่สมบูรณ์ (ชำรุดรอซ่อม)','QR Code ไม่สมบูรณ์ (รอตัดชำรุด)')
