...
const createAsset = async (createAssetData) => {
  ...
  try {
    ...
    const insertAsset = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_Add_Assets_Counted @Reference, @Date, @Status, @RoundID, @UserBranch, @UserID, @Code`);
    //sql.close()
...
const updateReference = async (referenceData) => {
  ...
  try {
    ...
    const update = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Mobile_update_reference @Reference, @UserID, @Code, @RoundID, @choice`);
    //sql.close()
...
const AssetsAll_Control = async (assetsAll_Control) => {
  ...
  try {
    ...
    const assetsBranchID_Control = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Mobile_AssetsAll_Control @BranchID`);
    //sql.close()
...
const store_FA_control_creat_Detail = async (FA_control_creat_Detail) => {
  ...
  try {
    ...
    const control_creat_Detail = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_Create_Detail_NAC @usercode, @nac_code, @nacdtl_row, @nacdtl_assetsCode, @nacdtl_assetsName, @nacdtl_assetsSeria, @nacdtl_assetsDtl, @nacdtl_assetsCount, @nacdtl_assetsPrice, @nacdtl_date_asset`);
    //sql.close()
...
const store_FA_control_update_DTLandHeaders = async (FA_control_update_DTLandHeaders) => {
  ...
  try {
    ...
    const update_DTLandHeaders = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_Update_DTLandHEADERS @usercode, @nac_code, @nac_status, @sumPrice, @nac_type, @des_department, @des_BU, @des_delivery, @des_deliveryDate, @des_description, @source_department, @source_BU, @source , @sourceDate, @source_description`);
    //sql.close()
...
const store_FA_control_update_DTL = async (FA_control_update_DTL) => {
  ...
  try {
    ...
    const update_DTL = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_Update_DTL @dtl_id, @usercode, @nac_code, @nacdtl_row, @nacdtl_assetsCode, @nacdtl_assetsName, @nacdtl_assetsSeria, @nacdtl_assetsDtl, @nacdtl_assetsCount, @nacdtl_assetsPrice, @asset_id`);
    //sql.close()
...
const store_FA_control_updateStatus = async (FA_control_updateStatus) => {
  ...
  try {
    ...
    const control_updateStatus = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_updateStatus @usercode , @nac_code, @nac_status, @nac_type, @source, @sourceDate, @des_delivery, @des_deliveryDate, @source_approve, @source_approve_date, @des_approve , @des_approve_date, @verify_by, @verify_date, @new_Price`);
    //sql.close()
...
const FA_Control_New_Assets = async (req) => {
  ...
  try {
    ...
    const fetch_assets = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.FA_Control_New_Assets @UserCode, @Code, @Name, @BranchID, @Details , @SerialNo, @Price, @Create_Date`);
    //sql.close()
    return fetch_assets.recordset;
  } catch (error) {
    //sql.close()
...
const FA_Control_New_Assets_Xlsx = async (req) => {
  ...
  try {
    ...
    const fetch_assets = await pool.request()
      ...
      .query(`exec ${config.PTEC.object_test_ops.sql.database}.dbo.[FA_Control_Upload_Assets_Xlsx] @Code, @Name, @BranchID , @OwnerCode, @SerialNo, @Price, @CreateDate, @CreateBy, @Position, @Details, @key`);
    //sql.close()
    return fetch_assets.recordset;
  } catch (error) {
    //sql.close()
